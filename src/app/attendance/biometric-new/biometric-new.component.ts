...
@Component({
  selector: 'app-biometric-new',
  templateUrl: './biometric-new.component.html',
  styleUrls: ['./biometric-new.component.scss']
})
export class BiometricNewComponent implements OnInit {

...
@Component({
  selector: 'app-fileuploadingnew',
  templateUrl: './fileuploadingnew.component.html',
  styleUrls: ['./fileuploadingnew.component.scss']
})
export class FileuploadingNewComponent implements OnInit {
  ...
  if(this.submitted){   
    if (input.files && input.files[0]) {
      ...
      this.apicall.UploadbiometricdataNew(fdata,this.empcode).subscribe((res)=>{
    //  alert(res)
        if(res>=0)
        {
